...
internal class StudyRegisterTest {
    ...
    fun testHuman() {
        ...
        assertEquals("Abebe Bikila", a.name)
        assertEquals(21, a.age)
        a.getOlder()
    ...
    fun testMajor() {
        ...
        assertEquals(2.0, majorMin, EPS)
        assertEquals(4.5, majorMax, EPS)
        assertEquals(3.0897, majorAverage, EPS)

        val (majorMin2, majorMax2, majorAverage2) = major.stats("Kotlin basics")
        assertEquals(2.0, majorMin2, EPS)
        assertEquals(5.0, majorMax2, EPS)
        assertEquals(3.6667, majorAverage2, EPS) // Oikea keskiarvo
    }
}
